...
//Luego tenemos que iniciar la validación por SMTP:
		...
		$mail->Username = "alvchasa@gmail.com";
		$mail->Password = "2726198sk8";
		$mail->Port = 465;
		...
		$mail->From = $email;
		$mail->FromName = "Drum-mail";
		$mail->Subject = "Verificar cuenta";
		$mail->AltBody = "Ha recibido un mensaje";
		...
		$mail->MsgHTML("<p>Por favor has clik para activar tu cuenta de Drum-mail</p><a href=$link>Verificar codigo</a>");
		...
		if ($exito) {
			...
			echo " Ups hubo un inconveniente. Contacta a un administrador";
		}
